    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="space-y-4 max-w-lg">
        <div className="p-6 rounded-lg border border-gray-200 bg-white shadow-sm">
          ...
          <p className="text-sm text-gray-700">Email: <a className="text-mei-600 font-medium" href="mailto:contato@calculamei.com.br">contato@calculamei.com.br</a></p>
        ...
        <div className="p-6 rounded-lg border border-gray-200 bg-white shadow-sm">
          ...
          <p className="text-sm text-gray-700">Para parcerias e imprensa, envie um email para <a className="text-mei-600 font-medium" href="mailto:contato@calculamei.com.br">contato@calculamei.com.br</a> com o assunto apropriado.</p>
        </div>
      </div>
    </div>
  )
